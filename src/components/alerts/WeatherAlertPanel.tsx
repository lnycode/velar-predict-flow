        ...
        <CardContent className="pt-6 relative">
          <div className="flex items-center justify-between mb-4">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h3 className="font-semibold text-foreground">{t('weatherAlert.title')}</h3>
                <p className="text-xs text-muted-foreground">
                  {isMonitoring ? t('weatherAlert.activeMonitoring') : t('weatherAlert.paused')}
                </p>
              </div>
            </div>
          ...
          {currentAlert && (
            <>
              <div className="flex items-center gap-2 mb-3">
                ...
                <span className="text-sm text-muted-foreground">{t('weatherAlert.riskScore')}</span>
              </div>
          ...
          {!currentAlert && (
            <div className="text-center py-4">
              ...
              <p className="text-sm text-muted-foreground">{t('weatherAlert.noAlerts')}</p>
            </div>
          )}
        ...
        <CardHeader className="relative">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-3">
              ...
              <div>
                <CardTitle className="text-xl">{t('weatherAlert.realtimeTitle')}</CardTitle>
                <CardDescription>
            ...
            <div className="flex items-center gap-2">
              ...
              >
                ...
                {isMonitoring ? t('weatherAlert.monitoring') : t('weatherAlert.start')}
              </Button>
            </div>
          </div>
        </CardHeader>
        ...
        <CardContent className="relative space-y-6">
          ...
          {currentAlert ? (
            <div className={cn(
              ...
              <div className="flex items-start justify-between mb-4">
                <div>
                  <div className="flex items-center gap-2 mb-1">
                    ...
                    <span className="font-semibold text-lg">
                      {currentAlert.riskLevel === 'critical' ? t('weatherAlert.criticalAlert') :
                       currentAlert.riskLevel === 'high' ? t('weatherAlert.highRisk') :
                       currentAlert.riskLevel === 'medium' ? t('weatherAlert.moderateRisk') : t('weatherAlert.lowRisk')}
                    </span>
                  </div>
                ...
                <div className="text-right">
                  ...
                  <p className="text-sm opacity-80">{t('weatherAlert.riskScore')}</p>
                </div>
              </div>
              ...
              {currentAlert.triggers.length > 0 && (
                <div className="space-y-2 mb-4">
                  <h4 className="font-medium text-sm">{t('weatherAlert.activeTriggers')}</h4>
              ...
              {!currentAlert.acknowledged && currentAlert.riskLevel !== 'low' && (
                ...
                >
                  ...
                  {t('weatherAlert.acknowledgeAlert')}
                </Button>
              )}
            </div>
          ) : (
            <div className="text-center py-8">
              ...
              <Button onClick={() => checkWeather()} disabled={isLoading}>
                ...
                {t('weatherAlert.checkWeatherNow')}
              </Button>
            </div>
          )}
            ...
            <>
              ...
              <div>
                <h3 className="font-semibold mb-4 flex items-center gap-2">
                  ...
                  {t('weatherAlert.currentConditions')}
                </h3>
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                  <div className="p-4 rounded-lg bg-secondary/20">
                    <div className="flex items-center gap-2 mb-2">
                      ...
                      <span className="text-xs text-muted-foreground">{t('weatherAlert.temperature')}</span>
                    </div>
                  ...
                  <div className="p-4 rounded-lg bg-secondary/20">
                    <div className="flex items-center gap-2 mb-2">
                      ...
                      <span className="text-xs text-muted-foreground">{t('weatherAlert.humidity')}</span>
                    </div>
                  ...
                  <div className="p-4 rounded-lg bg-secondary/20">
                    <div className="flex items-center gap-2 mb-2">
                      ...
                      <span className="text-xs text-muted-foreground">{t('weatherAlert.pressure')}</span>
                    </div>
                  ...
                  <div className="p-4 rounded-lg bg-secondary/20">
                    <div className="flex items-center gap-2 mb-2">
                      ...
                      <span className="text-xs text-muted-foreground">{t('weatherAlert.wind')}</span>
                    </div>
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h4 className="font-medium">{t('weatherAlert.pushNotifications')}</h4>
                <p className="text-sm text-muted-foreground">
                  {isSupported 
                    ? t('weatherAlert.notificationsEnabled')
                    : t('weatherAlert.notificationsNotSupported')
                  }
                </p>
              </div>
            </div>
        ...
        <Card className="velar-card">
          <CardHeader>
            <CardTitle className="text-lg flex items-center gap-2">
              ...
              {t('weatherAlert.alertHistory')}
            </CardTitle>
            <CardDescription>
              {t('weatherAlert.alertHistoryDesc')}
            </CardDescription>
          </CardHeader>
                ...
                >
                  <div className="flex items-center justify-between mb-2">
                    <div className="flex items-center gap-2">
                      ...
                      <span className="text-sm font-medium">{alert.riskScore}% {t('weatherAlert.risk')}</span>
                    </div>
